...
class SettingsScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return ListenableBuilder(
      listenable: Listenable.merge([app.daemon, app.session, app.prefs]),
      builder: (context, _) =>
          _Body(daemon: app.daemon, session: app.session, prefs: app.prefs),
    );
  }
}
  ...
  Widget _daemonPanel(BuildContext context, FilamentTheme theme) {
    ...
    return MeshPanel(
      ...
      child: MeshFacts([
        ...
        MeshFact(
          label: 'Socket',
          child: MeshCopyable(daemon.endpoint, style: theme.type.monoEmphasis),
        ),
        MeshFact(
          label: 'State',
